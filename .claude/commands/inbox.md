...
`vault_structure[category].doc_titles` 에서 문서 내용과 관련된 기존 문서를 식별한다.
재작성 시 위키링크(`[[문서명]]`)로 연결할 후보 목록을 메모해 둔다.
...
변경 내역:
  20_Projects/Obsidian/ → 앱_출시_체크리스트.md
  40_Resources/Documentation/ → 독서노트_원칙.md
